...
<head>
    ...
    <title>TOURISME - Registro</title>
    <link rel="stylesheet" href="/client/src/assets/css/registro.css">
    ...
    <main>
        <div class="register-container">
            <div class="register-card">
                ...
                <p class="subtitle">Crea tu cuenta para comenzar a viajar</p>

                <form id="registerForm" class="form-container">

                    <div class="input-group">
                        <label for="rol">Tipo de rol <span class="required">*</span></label>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" id="contrasena_hash" name="contrasena_hash" required placeholder="Ingrese contraseña">
